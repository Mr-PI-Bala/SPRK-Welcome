...
### Changed
- Expanded the MERIT/AURAVYBE proprietary license to address patent, contribution, notice, support, indemnity, and liability gaps.
- Added compact heading guidance to `docs/PROJECT_GUIDE.md`.
- Removed unnecessary blank lines immediately after Markdown headings.
...
### Added
- Added public doorway README.
- Added student `USER_GUIDE.md`.
- Added maintainer `PROJECT_GUIDE.md`.
- Added MERIT/AURAVYBE proprietary educational license.
- Added VS Code/Codespaces settings and extension recommendations.
